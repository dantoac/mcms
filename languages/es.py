...
'Cms Body': 'Cms Body',
'Cms Html': 'Cms Html',
'Cms medias(created_by)': 'Cms medias(created_by)',
'Cms medias(modified_by)': 'Cms medias(modified_by)',
'Cms Page': 'Cms Page',
'Cms pages': 'Cms pages',
'Cms pages(created_by)': 'Cms pages(created_by)',
'Cms pages(modified_by)': 'Cms pages(modified_by)',
'Cms Render': 'Cms Render',
'Cms Slug': 'Cms Slug',
'Cms tags': 'Cms tags',
'Cms tagses': 'Cms tagses',
'Cms Title': 'Cms Title',
'Cms Uuid': 'Cms Uuid',
'Community': 'Comunidad',
'compile': 'compilar',
...
'Mcms Body': 'Mcms Body',
'Mcms Excerpt': 'Mcms Excerpt',
'Mcms medias': 'Mcms medias',
'Mcms Name': 'Mcms Name',
'Mcms Page': 'Mcms Page',
'Mcms Page Id': 'Mcms Page Id',
'Mcms pages': 'Mcms pages',
'Mcms Slug': 'Mcms Slug',
'Mcms tags': 'Mcms tags',
'Mcms Title': 'Mcms Title',
'Medias(created_by)': 'Medias(created_by)',
'Medias(modified_by)': 'Medias(modified_by)',
'Menu Item': 'Menu Item',
...
'Wiki medias(created_by)': 'Wiki medias(created_by)',
'Wiki medias(modified_by)': 'Wiki medias(modified_by)',
'Wiki Page': 'Wiki Page',
'Wiki pages(created_by)': 'Wiki pages(created_by)',
'Wiki pages(modified_by)': 'Wiki pages(modified_by)',
'Wiki tags(created_by)': 'Wiki tags(created_by)',
'Wiki tags(modified_by)': 'Wiki tags(modified_by)',
'Working...': 'Trabajando...',
'XML': 'XML',
'YES': 'SÍ',
